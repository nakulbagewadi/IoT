...
#---------------------------------------------------------
#
#	This is a program for Barometer Pressure Sensor Module.
#       It could measure the pressure and temperature.
#
#	This program depend on BMP085.py writted by Adafruit. 
#
#	   Barometer Module		        Pi
#			VCC ----------------- 3.3V
#			GND ------------------ GND
...
def loop():
	while True:
		...
		altitude = sensor.read_altitude()	# Read altitude to variable altitude

		print ''
		print '      Temperature = {0:0.2f} C'.format(temp)	# Print temperature
		print '      Pressure = {0:0.2f} Pa'.format(pressure)	# Print pressure
		print '      Altitude = {0:0.2f} m'.format(altitude)	# Print altitude
		time.sleep(1)			
		print ''
